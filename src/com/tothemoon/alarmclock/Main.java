...
import com.tothemoon.data.AlarmData;
import com.tothemoon.io.AlarmDatebaseUtil;
...
public class Main extends FragmentActivity implements ActionBar.TabListener,DummyFragment.Callbacks{
	...
	public void AddAlarm(AlarmData addedAlarmData) {
		...
		now = datenow.get(Calendar.DAY_OF_WEEK)*10000 + datenow.get(Calendar.HOUR_OF_DAY)*1000 + datenow.get(Calendar.MINUTE)*100 +1;
